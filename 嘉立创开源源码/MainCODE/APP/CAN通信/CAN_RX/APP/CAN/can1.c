...
/********************************全局变量定义区 ******************************/
struct CAN_STRUCT my_can_struct={0};
/****************************************************************************/

/********************************静态函数定义区 ******************************/
#if CAN_MODE_CAN_NORMAL
...
static void can_mode_config(uint8_t bs1,uint8_t bs2,uint8_t sjw,uint16_t pre)	
{
	...
	CAN_StructInit(&CAN_InitTypeStruct);

	CAN_InitTypeStruct.CAN_ABOM = ENABLE;
	CAN_InitTypeStruct.CAN_AWUM = ENABLE;
	CAN_InitTypeStruct.CAN_Mode = CAN_Mode_Normal;
