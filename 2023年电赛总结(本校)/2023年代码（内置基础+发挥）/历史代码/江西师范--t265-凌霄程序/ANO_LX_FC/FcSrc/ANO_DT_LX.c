...
void t265_data_send(void)
{
	...
	t265_send[cnt++]=0xf1;
	t265_send[cnt++]=0x00;
	t265_send[cnt++]=BYTE0(t265.pi_f);
	t265_send[cnt++]=BYTE1(t265.pi_f);
	t265_send[cnt++]=BYTE0(t265.ro_f);
	t265_send[cnt++]=BYTE1(t265.ro_f);
	t265_send[cnt++]=BYTE0(t265.ya_f);
	t265_send[cnt++]=BYTE1(t265.ya_f);
	
	t265_send[cnt++]=BYTE0(t265.pos_x_f);
	t265_send[cnt++]=BYTE1(t265.pos_x_f);
	t265_send[cnt++]=BYTE0(t265.pos_y_f);
	t265_send[cnt++]=BYTE1(t265.pos_y_f);
	t265_send[cnt++]=BYTE0(t265.pos_z_f);
	t265_send[cnt++]=BYTE1(t265.pos_z_f);
	
	t265_send[cnt++]=BYTE0(t265.v_x_f);
	t265_send[cnt++]=BYTE1(t265.v_x_f);
	t265_send[cnt++]=BYTE0(t265.v_y_f);
	t265_send[cnt++]=BYTE1(t265.v_y_f);
	t265_send[cnt++]=BYTE0(t265.v_z_f);
	t265_send[cnt++]=BYTE1(t265.v_z_f);


	t265_send[cnt++]=BYTE0(t265.ctrl_mode);
	t265_send[cnt++]=BYTE1(t265.ctrl_mode);
