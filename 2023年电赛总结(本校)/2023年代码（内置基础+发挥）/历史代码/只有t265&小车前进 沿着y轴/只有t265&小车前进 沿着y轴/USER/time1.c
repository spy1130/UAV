...
void NVIC_TIM2Enable(void)
{
	...
	NVIC_initstructure.NVIC_IRQChannelPreemptionPriority = 1; //设定抢占优先级为 0
...
//			down_flag=0;
//		}
//		else if((string_pb6==1)&&(string_pb7==0))
//		{
//			//stop
//			
//			steering_pwmval=1500;//high mean low speed
